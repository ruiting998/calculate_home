...
var Line = /** @class */ (function (_super) {
    ...
    function Line(_a) {
        ...
        var _this = this;
        var style = _a.style, rest = tslib.__rest(_a, ["style"]);
        _this = _super.call(this, tslib.__assign({ type: exports.Shape.LINE, style: tslib.__assign({ x1: 0, y1: 0, x2: 0, y2: 0, z1: 0, z2: 0, isBillboard: false }, style) }, rest)) || this;
    ...
    function Text(_a) {
        ...
        return _super.call(this, tslib.__assign({ type: exports.Shape.TEXT, style: runtime.enableCSSParsing
                ? tslib.__assign({ x: '', y: '', text: '', fontSize: '', fontFamily: '', fontStyle: '', fontWeight: '', fontVariant: '', textAlign: '', textBaseline: '', textTransform: '', fill: 'black', letterSpacing: '', lineHeight: '', miterLimit: '', 
                    // whiteSpace: 'pre',
                    wordWrap: false, wordWrapWidth: 0, leading: 0, dx: '', dy: '', isBillboard: false, sizeAttenuation: true }, style) : tslib.__assign({ fill: 'black' }, style), initialParsedStyle: runtime.enableCSSParsing
                ? {}
                : {
                    x: 0,
                    y: 0,
...
var PrepareRendererPlugin = /** @class */ (function () {
    ...
    PrepareRendererPlugin.prototype.syncRTree = function () {
        ...
        Array.from(this.toSync)
            ...
            if (renderBounds) {
                var minX = (_a = tslib.__read(renderBounds.getMin(), 2), _a[0]), minY = _a[1];
                var maxX = (_b = tslib.__read(renderBounds.getMax(), 2), _b[0]), maxY = _b[1];
                if (!rBushNode.aabb) {
                    rBushNode.aabb = {};
                }

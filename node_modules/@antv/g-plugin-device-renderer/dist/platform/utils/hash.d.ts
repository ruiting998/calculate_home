import type { BindingLayoutDescriptor, BindingLayoutSamplerDescriptor, BindingsDescriptor, BufferBinding, InputLayoutBufferDescriptor, InputLayoutDescriptor, RenderPipelineDescriptor, SamplerBinding, SamplerDescriptor, VertexAttributeDescriptor } from '../interfaces';
...
export declare function bindingLayoutDescriptorEqual(a: Readonly<BindingLayoutDescriptor>, b: Readonly<BindingLayoutDescriptor>): boolean;
export declare function bindingsDescriptorEquals(a: Readonly<BindingsDescriptor>, b: Readonly<BindingsDescriptor>): boolean;
...
export declare function samplerBindingNew(): SamplerBinding;
...
export declare function bindingLayoutSamplerDescriptorCopy(a: Readonly<BindingLayoutSamplerDescriptor>): BindingLayoutSamplerDescriptor;
export declare function bindingLayoutDescriptorCopy(a: Readonly<BindingLayoutDescriptor>): BindingLayoutDescriptor;

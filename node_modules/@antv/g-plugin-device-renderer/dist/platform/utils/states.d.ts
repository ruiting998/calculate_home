import type { AttachmentState, BindingLayoutSamplerDescriptor, MegaStateDescriptor } from '../interfaces';
...
export declare const defaultBindingLayoutSamplerDescriptor: BindingLayoutSamplerDescriptor;

...
import { Device, SwapChain, Texture, TextureDescriptor } from './platform';
...
export declare class RenderGraphPlugin implements RenderingPlugin {
    ...
    static tag: string;
    private context;
    constructor(renderHelper: RenderHelper, lightPool: LightPool, texturePool: TexturePool, batchManager: BatchManager);
    private device;
    private swapChain;
    private renderLists;
    /**

...
export declare class RenderInstManager {
    renderCache: RenderCache;
    instPool: RenderInstPool;
    templatePool: RenderInstPool;
    simpleRenderInstList: RenderInstList | null;
    currentRenderInstList: RenderInstList;
     ...
     * after submitting it.
     */
    submitRenderInst(renderInst: RenderInst, list?: RenderInstList): void;
    /**

 ...
 */
export declare const RENDER_ORDER_SCALE: number;
/**
...
export declare abstract class Batch {
    ...
    beforeUploadUBO(renderInst: RenderInst, mesh: Instanced, index: number): void;
    beforeInitMesh(mesh: Instanced): void;
    afterInitMesh(mesh: Instanced): void;
}

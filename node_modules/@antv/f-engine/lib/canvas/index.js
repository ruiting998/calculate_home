...
var _gMobileCanvasElement = require("@antv/g-mobile-canvas-element");
var _gMobileCanvas = require("@antv/g-mobile-canvas");
var _updater = require("../component/updater");
...
require("@antv/g-web-animations-api");
// 添加动画模块
...
function measureText(container, px2hd, theme) {
  return function (text, font) {
    ...
    var result = (0, _util2.checkCSSRule)('text', style);
    var shape = new _gLite.Text({
      style: result
    });
...
var Canvas = /** @class */function () {
  function Canvas(props) {
    var context = props.context,
      _a = props.renderer,
      renderer = _a === void 0 ? new _gMobileCanvas.Renderer() : _a,
      width = props.width,
      height = props.height,
    ...
    // 初始化主题
    var theme = px2hd((0, _tslib.__assign)((0, _tslib.__assign)({}, _theme.default), customTheme));
    var pixelRatio = theme.pixelRatio,
      fontSize = theme.fontSize,
      fontFamily = theme.fontFamily;
    var devicePixelRatio = customPixelRatio ? customPixelRatio : pixelRatio;
    // 组件更新器
    var updater = (0, _updater.createUpdater)(this);
    var canvasElement = (0, _gMobileCanvasElement.createMobileCanvasElement)(context);
    var canvas = new _gLite.Canvas({
      ...
      supportsPointerEvents: _gLite.runtime.globalThis.PointerEvent ? true : false,
      // 允许在canvas外部触发
    ...
    var gesture = new _gesture.default(container);
    // 供全局使用的一些变量
    ...
    this.updateLayout((0, _tslib.__assign)((0, _tslib.__assign)({}, props), {
      width: canvasWidth,
      height: canvasHeight
    }));
  }
  Canvas.prototype.updateComponents = function (components) {
    (0, _render.updateComponents)(components);
  };
      ...
      return (0, _tslib.__generator)(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            this.updateLayout((0, _tslib.__assign)((0, _tslib.__assign)({}, this.props), {
              width: width,
              height: height
            }));
            return [4 /*yield*/, this.render()];
  ...
  Canvas.prototype.updateLayout = function (props) {
    ...
    var _a = this.context,
      px2hd = _a.px2hd,
      theme = _a.theme;
    var style = px2hd((0, _tslib.__assign)({
      left: 0,
      top: 0,
      width: width,
      height: height,
    ...
    this.context = (0, _tslib.__assign)((0, _tslib.__assign)({}, this.context), {
      left: left,
      top: top,
      width: layout.width,
      height: layout.height
    });
    this.vNode = (0, _tslib.__assign)((0, _tslib.__assign)({}, this.vNode), {
      style: layout,
  ...
  Canvas.prototype.destroy = function () {
    var _a = this,
      ...
      el = _a.el;
    (0, _render.destroyElement)(children);

...
import { CanvasEvent, ElementEvent, RenderReason, isCSSRGB, isPattern, runtime, Shape, AbstractRendererPlugin } from '@antv/g-lite';
...
var HTMLRenderingPlugin = /** @class */ (function () {
    ...
    HTMLRenderingPlugin.prototype.apply = function (context) {
        var _this = this;
        ...
        var handleMounted = function (e) {
            ...
            if (object.nodeName === Shape.HTML) {
                ...
                runtime.nativeHTMLMap.set($el_1, object);
            }
        };
    ...
    HTMLRenderingPlugin.prototype.createCamera = function (camera) {
        var _a;
        var doc = (_a = this.context.config, _a.document), width = _a.width, height = _a.height;
